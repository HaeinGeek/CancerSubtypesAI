...
def main():
    ...
    fetcher.process_isoforms('uniprot', genes_dict['uniprot'])
    fetcher.process_isoforms('ncbi', genes_dict['ncbi'], email=email)
    fetcher.process_isoforms('pdb', genes_dict['pdb'])
    fetcher.process_isoforms('ensembl', genes_dict['ensembl'], species='homo_sapiens', max_workers=5)
